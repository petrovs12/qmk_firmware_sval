...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      [_QWERTY] = LAYOUT_5x6(
         ...
         KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B,                             KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_SLASH,
      ...
      [_LOWER] = LAYOUT_5x6(
         ...
         _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE, _______,             _______, _______, _______, _______, _______, QK_RBT,
      ...
      [_RAISE] = LAYOUT_5x6(
         ...
         QK_RBT,  KC_F1,   KC_F2,   KC_F3,   KC_F4,    KC_F5,               KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  _______,
                           _______, _______,                                                  KC_F11, KC_F12,
                                               _______, _______,            _______, _______,
                                               _______, _______,            ADJUST,  C(KC_RIGHT),
                                               _______, _______,            _______, C(KC_LEFT)
      ),
